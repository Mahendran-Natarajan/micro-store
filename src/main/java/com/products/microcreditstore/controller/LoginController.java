...
public class LoginController {
    ...
    public ResponseEntity<LoginResponseDto> loginUser(@RequestBody UserLogin userLogin) {
        ...
        ResponseEntity<LoginResponseDto> loginResponse = restTemplate.postForEntity(uri, userLogin, LoginResponseDto.class);
        logger.info(loginResponse.getBody().toString());
